...
am2_control = Run(
    ...
    data_in_direc=('/archive/Yi.Ming/sm2.1_fixed/SM2.1U_Control-1860_lm2_aie_rerun6.YIM/pp'),
    data_in_dur=100,
#    nc_start_yr=1,
#    nc_end_yr=100,
...
am2_tropics = Run(
    ...
    data_in_direc=('/archive/Yi.Ming/sm2.1_fixed/SM2.1U_Control-1860_lm2_aie2_tropical_rerun6.YIM/pp'),
    data_in_dur=20,
#    nc_start_yr=1,
#    nc_end_yr=80,
#    default_yr_range=(21,80),
...
am2_extratropics = Run(
    ...
    data_in_direc=('/archive/Yi.Ming/sm2.1_fixed/SM2.1U_Control-1860_lm2_aie2_extropical_rerun6.YIM/pp'),
    data_in_dur=20,
#    nc_start_yr=1,
#    nc_end_yr=80,
#    default_yr_range=(21,80),
...
am2_tropics_and_extratropics = Run(
    ...
    data_in_direc=('/archive/Yi.Ming/sm2.1_fixed/SM2.1U_Control-1860_lm2_aie2_rerun6.YIM/pp'),
    data_in_dur=20,
#    nc_start_yr=1,
#    nc_end_yr=80,
#    default_yr_range=(21,80),
...
am2_reyoi_control = Run(
    ...
    data_in_direc='/archive/Spencer.Hill/am2/am2clim_reyoi/gfdl.ncrc2-default-prod/pp',
    data_in_dur=1,
#    nc_start_yr=1982,
#    nc_end_yr=2012,
...
am2_reyoi_extratropics_full = Run(
    ...
    data_in_direc=('/archive/Spencer.Clark/am2/am2clim_reyoi_extratropics_full/gfdl.ncrc2-default-prod/pp'),
    data_in_dur=17,
#    nc_start_yr=1982,
#    nc_end_yr=1998,
...
am2_reyoi_extratropics_sp = Run(
    ...
    data_in_direc=('/archive/Spencer.Clark/am2/am2clim_reyoi_extratropics_sp/gfdl.ncrc2-default-prod/pp'),
    data_in_dur=17,
#    nc_start_yr=1982,
#    nc_end_yr=1998,
#    default_yr_range=(1982,1998),
