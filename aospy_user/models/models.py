...
am2_reyoi = Model(
    name='am2_reyoi',
    grid_file_paths=(
        ('/archive/yim/siena_201203/m45_am2p14_1990/gfdl.ncrc2-intel-prod/pp/atmos/atmos.static.nc',
         '/archive/yim/siena_201203/m45_am2p14_1990/gfdl.ncrc2-intel-prod/pp/atmos_level/atmos_level.static.nc',
         '/archive/yim/siena_201203/m45_am2p14_1990/gfdl.ncrc2-intel-prod/pp/atmos/ts/annual/16yr/atmos.1983-1998.temp.nc',
         '/archive/yim/siena_201203/m45_am2p14_1990/gfdl.ncrc2-intel-prod/pp/atmos_level/ts/monthly/16yr/atmos_level.198301-199812.temp.nc'
        )
        ),
    runs=[runs.am2_HadISST_control, runs.am2_reyoi_extratropics_full, runs.am2_reyoi_extratropics_sp, runs.am2_reyoi_extratropics_u, runs.am2_reyoi_control,
          runs.am2_reyoi_extratropics_sp_SI, runs.am2_reyoi_tropics_sp_SI, runs.am2_reyoi_tropics_full, runs.am2_reyoi_tropics_u],
    default_runs=[runs.am2_HadISST_control, runs.am2_reyoi_extratropics_full, runs.am2_reyoi_extratropics_sp, runs.am2_reyoi_extratropics_u, runs.am2_reyoi_control,
          runs.am2_reyoi_extratropics_sp_SI, runs.am2_reyoi_tropics_sp_SI, runs.am2_reyoi_tropics_full, runs.am2_reyoi_tropics_u]
)
...
dargan_T42 = Model(
    name='dargan_T42',
    grid_file_paths=(
        ('/archive/skc/idealized_moist_alb_T42/control_alb_T42/gfdl.ncrc2-default-prod/1x0m720d_32pe/history/00000.1x20days.nc'),
         ),
