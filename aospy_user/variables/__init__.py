...
cre_net = Var(
    ...
    # variables=(swdn_toa, swup_toa, olr, swdn_toa_clr, swup_toa_clr, olr_clr),
...
cre_sw = Var(
    ...
    # variables=(swdn_toa, swup_toa, swdn_toa_clr, swup_toa_clr),
...
dse_horiz_advec = Var(
    ...
    variables=(temp, hght, ucomp, vcomp, lat, lon, r_e),
    def_time=True,
    def_vert=True,
    def_lat=True,
    def_lon=True,
...
dse_times_horiz_divg = Var(
    ...
    variables=(temp, hght, ucomp, vcomp, lat, lon, r_e, 'dp'),
    def_time=True,
    def_vert='pfull',
    def_lat=True,
    def_lon=True,
...
gross_moist_strat = Var(
    ...
    domain='atmos',
    description='',
    variables=(sphum, ucomp, vcomp, lat, lon, r_e, 'dp'),
    def_time=True,
    def_vert=False,
    def_lat=True,
    def_lon=True,
...
hght_horiz_advec = Var(
    ...
    variables=(hght, ucomp, vcomp, lat, lon, r_e),
    def_time=True,
    def_vert=True,
    def_lat=True,
    def_lon=True,
...
hght_times_horiz_divg = Var(
    ...
    variables=(hght, ucomp, vcomp, lat, lon, r_e, 'dp'),
    def_time=True,
    def_vert='pfull',
    def_lat=True,
    def_lon=True,
...
temp_horiz_advec = Var(
    ...
    variables=(temp, ucomp, vcomp, lat, lon, r_e),
    def_time=True,
    def_vert=True,
    def_lat=True,
    def_lon=True,
...
temp_times_horiz_divg = Var(
    ...
    variables=(temp, ucomp, vcomp, lat, lon, r_e, 'dp'),
    def_time=True,
    def_vert=True,
    def_lat=True,
    def_lon=True,
...
tdt_diab = Var(
    ...
    #tdt_diab.variables=(tdt_lw, tdt_sw, tdt_conv, tdt_ls, tdt_vdif),
